---
title: CLI Options
description: Full reference for create-launchframe CLI flags.
---
...
If no options are provided, the CLI runs in **interactive mode** with arrow-key selection.
...
3. Resolves **modules** based on your CLI options (e.g., `db-pg`, `billing-stripe`)
