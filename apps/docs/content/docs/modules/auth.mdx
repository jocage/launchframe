...
description: Better Auth integration with email/password and optional GitHub OAuth.
---

Launchframe uses [Better Auth](https://www.better-auth.com/) for authentication — a modern, type-safe auth library for Next.js.
